      ...
      <div class="header-right">
        <div class="profile_details_left"><!--notifications of menu start -->
          <ul class="nofitications-dropdown">
            <?php
$ret1=mysqli_query($con,"select * from  tblregistration where Status is null");
...
{
            ?>
                 <a class="dropdown-item" href="view-regdetails.php?viewid=<?php echo $result['ID'];?>">New registration received from <?php echo $result['Name'];?> </a><br />
<?php }} else {?>
    <a class="dropdown-item" href="all-registration.php">No New Registration Received</a>
        <?php } ?>
